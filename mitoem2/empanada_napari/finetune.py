...
from mitoem2.empanada import losses
from mitoem2.empanada import data
from mitoem2.empanada import metrics
from mitoem2.empanada.inference import engines
from mitoem2.empanada.data.utils import FactorPad

from mitoem2.empanada_napari.utils import load_model_to_device
...
def main_worker(config):
    ...
    print(f'Using augmentations: {config["aug_string"]}')
    tfs = A.Compose([
        *dataset_augs,
        A.Normalize(**norms),
        ToTensorV2()
