...
def training_widget():
    ...
    from mitoem2.empanada_napari.utils import abspath, get_configs, add_new_model
    from mitoem2.empanada.config_loaders import load_config
    from mitoem2.empanada.models import quantization as quant_models
    ...
    def run_training(config):
        from mitoem2.empanada_napari import train
