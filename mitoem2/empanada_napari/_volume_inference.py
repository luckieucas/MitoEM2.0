...
def volume_inference_widget():
    ...
    from mitoem2.empanada_napari.inference import Engine3d, tracker_consensus, stack_postprocessing
    from mitoem2.empanada_napari.multigpu import MultiGPUEngine3d
    from mitoem2.empanada_napari.utils import get_configs, abspath
    from mitoem2.empanada.config_loaders import read_yaml
